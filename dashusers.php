...
$sql = "select u.userid as userid, u.firstname as fname, u.lastname as lname, u.email as email, u.level as level, u.status as status, r.regionname as region from users as u inner join region as r on r.region_id = u.region where level < 5";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
   ...
   $nestedData[] = $row['region'];
	...
	//$buttonshow = "<a onclick='dashUsersDisplay({$row['userid']})' class='btn btn-rose btn-md '><i class='material-icons'>assignment</i></a>";
